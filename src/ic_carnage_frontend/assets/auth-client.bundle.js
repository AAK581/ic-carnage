(() => {
  ...
  var ReplicaRejectCode, QueryResponseStatus;
  var init_api = __esm({
    "node_modules/@dfinity/agent/lib/esm/agent/api.js"() {
  ...
  var HashMD, SHA256_IV, SHA224_IV, SHA512_IV;
  var init_md = __esm({
    "node_modules/@noble/hashes/esm/_md.js"() {
      init_utils();
  ...
  var init_u64 = __esm({
    "node_modules/@noble/hashes/esm/_u64.js"() {
      U32_MASK64 = /* @__PURE__ */ BigInt(__pow(2, 32) - 1);
      _32n = /* @__PURE__ */ BigInt(32);
      shrSH = (h2, _l, s2) => h2 >>> s2;
      shrSL = (h2, l, s2) => h2 << 32 - s2 | l >>> s2;
      rotrSH = (h2, l, s2) => h2 >>> s2 | l << 32 - s2;
      rotrSL = (h2, l, s2) => h2 << 32 - s2 | l >>> s2;
      rotrBH = (h2, l, s2) => h2 << 64 - s2 | l >>> s2 - 32;
      rotrBL = (h2, l, s2) => h2 >>> s2 - 32 | l << 64 - s2;
      add3L = (Al, Bl, Cl) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0);
      add3H = (low, Ah, Bh, Ch) => Ah + Bh + Ch + (low / __pow(2, 32) | 0) | 0;
      add4L = (Al, Bl, Cl, Dl) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0) + (Dl >>> 0);
      add4H = (low, Ah, Bh, Ch, Dh) => Ah + Bh + Ch + Dh + (low / __pow(2, 32) | 0) | 0;
      add5L = (Al, Bl, Cl, Dl, El) => (Al >>> 0) + (Bl >>> 0) + (Cl >>> 0) + (Dl >>> 0) + (El >>> 0);
      add5H = (low, Ah, Bh, Ch, Dh, Eh) => Ah + Bh + Ch + Dh + Eh + (low / __pow(2, 32) | 0) | 0;
    }
  });

  // node_modules/@noble/hashes/esm/sha2.js
  var SHA256_K, SHA256_W, SHA256, SHA224, K512, SHA512_Kh, SHA512_Kl, SHA512_W_H, SHA512_W_L, SHA512, sha256, sha224, sha512;
  var init_sha2 = __esm({
    "node_modules/@noble/hashes/esm/sha2.js"() {
      init_md();
      init_u64();
  ...
  var JSON_KEY_PRINCIPAL, SELF_AUTHENTICATING_SUFFIX, ANONYMOUS_SUFFIX, MANAGEMENT_CANISTER_PRINCIPAL_TEXT_STR, Principal;
  var init_principal = __esm({
    "node_modules/@dfinity/principal/lib/esm/principal.js"() {
      ...
      ANONYMOUS_SUFFIX = 4;
      MANAGEMENT_CANISTER_PRINCIPAL_TEXT_STR = "aaaaa-aa";
  ...
  var ErrorKindEnum, ErrorCode, AgentError, ErrorKind, TrustError, ProtocolError, RejectError, TransportError, ExternalError, InputError, UnknownError, CertificateVerificationErrorCode, CertificateTimeErrorCode, CertificateHasTooManyDelegationsErrorCode, CertificateNotAuthorizedErrorCode, LookupErrorCode, MalformedLookupFoundValueErrorCode, MissingLookupValueErrorCode, DerKeyLengthMismatchErrorCode, DerPrefixMismatchErrorCode, DerDecodeLengthMismatchErrorCode, DerDecodeErrorCode, DerEncodeErrorCode, CborDecodeErrorCode, CborEncodeErrorCode, TimeoutWaitingForResponseErrorCode, CertificateOutdatedErrorCode, CertifiedRejectErrorCode, UncertifiedRejectErrorCode, UncertifiedRejectUpdateErrorCode, RequestStatusDoneNoReplyErrorCode, MissingRootKeyErrorCode, HashValueErrorCode, HttpDefaultFetchErrorCode, IdentityInvalidErrorCode, IngressExpiryInvalidErrorCode, CreateHttpAgentErrorCode, MalformedSignatureErrorCode, MissingSignatureErrorCode, MalformedPublicKeyErrorCode, QuerySignatureVerificationFailedErrorCode, UnexpectedErrorCode, HashTreeDecodeErrorCode, HttpErrorCode, HttpV3ApiNotSupportedErrorCode, HttpFetchErrorCode, MissingCanisterIdErrorCode, InvalidReadStateRequestErrorCode, ExpiryJsonDeserializeErrorCode, UNREACHABLE_ERROR;
...
Call context:
  ...
  HTTP details: ${JSON.stringify(this.callContext.httpDetails, null, 2)}`;
      ...
      ErrorKind = class extends AgentError {
        static fromCode(code) {
          return new this(code);
        }
      };
      TrustError = class _TrustError extends ErrorKind {
        constructor(code) {
      ...
      ProtocolError = class _ProtocolError extends ErrorKind {
        constructor(code) {
      ...
      RejectError = class _RejectError extends ErrorKind {
        constructor(code) {
      ...
      TransportError = class _TransportError extends ErrorKind {
        constructor(code) {
      ...
      ExternalError = class _ExternalError extends ErrorKind {
        constructor(code) {
      ...
      InputError = class _InputError extends ErrorKind {
        constructor(code) {
      ...
      UnknownError = class _UnknownError extends ErrorKind {
        constructor(code) {
      ...
      CertificateVerificationErrorCode = class _CertificateVerificationErrorCode extends ErrorCode {
      ...
      CertificateTimeErrorCode = class _CertificateTimeErrorCode extends ErrorCode {
      ...
      CertificateHasTooManyDelegationsErrorCode = class _CertificateHasTooManyDelegationsErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      CertificateNotAuthorizedErrorCode = class _CertificateNotAuthorizedErrorCode extends ErrorCode {
      ...
      LookupErrorCode = class _LookupErrorCode extends ErrorCode {
      ...
      MalformedLookupFoundValueErrorCode = class _MalformedLookupFoundValueErrorCode extends ErrorCode {
        constructor(message) {
          super();
          this.message = message;
      ...
      MissingLookupValueErrorCode = class _MissingLookupValueErrorCode extends ErrorCode {
        constructor(message) {
          super();
          this.message = message;
      ...
      DerKeyLengthMismatchErrorCode = class _DerKeyLengthMismatchErrorCode extends ErrorCode {
      ...
      DerPrefixMismatchErrorCode = class _DerPrefixMismatchErrorCode extends ErrorCode {
      ...
      DerDecodeLengthMismatchErrorCode = class _DerDecodeLengthMismatchErrorCode extends ErrorCode {
        constructor(expectedLength, actualLength) {
          super();
          this.expectedLength = expectedLength;
          this.actualLength = actualLength;
      ...
      DerDecodeErrorCode = class _DerDecodeErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      DerEncodeErrorCode = class _DerEncodeErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      CborDecodeErrorCode = class _CborDecodeErrorCode extends ErrorCode {
      ...
      CborEncodeErrorCode = class _CborEncodeErrorCode extends ErrorCode {
      ...
      TimeoutWaitingForResponseErrorCode = class _TimeoutWaitingForResponseErrorCode extends ErrorCode {
...
`;
      ...
      CertificateOutdatedErrorCode = class _CertificateOutdatedErrorCode extends ErrorCode {
...
`;
      ...
      CertifiedRejectErrorCode = class _CertifiedRejectErrorCode extends ErrorCode {
...
`;
      ...
      UncertifiedRejectErrorCode = class _UncertifiedRejectErrorCode extends ErrorCode {
...
`;
      ...
      UncertifiedRejectUpdateErrorCode = class _UncertifiedRejectUpdateErrorCode extends ErrorCode {
        constructor(requestId, rejectCode, rejectMessage, rejectErrorCode) {
          super();
          this.requestId = requestId;
          this.rejectCode = rejectCode;
...
`;
      ...
      RequestStatusDoneNoReplyErrorCode = class _RequestStatusDoneNoReplyErrorCode extends ErrorCode {
...
`;
      ...
      MissingRootKeyErrorCode = class _MissingRootKeyErrorCode extends ErrorCode {
      ...
      HashValueErrorCode = class _HashValueErrorCode extends ErrorCode {
        constructor(value) {
          super();
          this.value = value;
      ...
      HttpDefaultFetchErrorCode = class _HttpDefaultFetchErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      IdentityInvalidErrorCode = class _IdentityInvalidErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      IngressExpiryInvalidErrorCode = class _IngressExpiryInvalidErrorCode extends ErrorCode {
      ...
      CreateHttpAgentErrorCode = class _CreateHttpAgentErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      MalformedSignatureErrorCode = class _MalformedSignatureErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      MissingSignatureErrorCode = class _MissingSignatureErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      MalformedPublicKeyErrorCode = class _MalformedPublicKeyErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      QuerySignatureVerificationFailedErrorCode = class _QuerySignatureVerificationFailedErrorCode extends ErrorCode {
        constructor(nodeId) {
          super();
          this.nodeId = nodeId;
      ...
      UnexpectedErrorCode = class _UnexpectedErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      HashTreeDecodeErrorCode = class _HashTreeDecodeErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      HttpErrorCode = class _HttpErrorCode extends ErrorCode {
...
`;
      ...
      HttpV3ApiNotSupportedErrorCode = class _HttpV3ApiNotSupportedErrorCode extends ErrorCode {
        constructor() {
          super();
      ...
      HttpFetchErrorCode = class _HttpFetchErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      MissingCanisterIdErrorCode = class _MissingCanisterIdErrorCode extends ErrorCode {
      ...
      InvalidReadStateRequestErrorCode = class _InvalidReadStateRequestErrorCode extends ErrorCode {
      ...
      ExpiryJsonDeserializeErrorCode = class _ExpiryJsonDeserializeErrorCode extends ErrorCode {
        constructor(error) {
          super();
          this.error = error;
      ...
      UNREACHABLE_ERROR = new Error("unreachable");
    }
  });
  ...
  function idlLabelToId(label) {
    if (/^_\d+_$/.test(label) || /^_0x[0-9a-fA-F]+_$/.test(label)) {
      ...
      if (Number.isSafeInteger(num) && num >= 0 && num < __pow(2, 32)) {
        return num;
      }
    }
  ...
  function readIntLE(pipe, byteLength) {
    ...
    const mul = __pow(BigInt(2), BigInt(8) * BigInt(byteLength - 1) + BigInt(7));
    if (val >= mul) {
      val -= mul * BigInt(2);
    }
    return val;
  ...
  var IDLTypeIds, magicNumber, toReadableString_max, TypeTable, Visitor, IdlTypeName, Type, PrimitiveType, ConstructType, EmptyClass, UnknownClass, BoolClass, NullClass, ReservedClass, TextClass, IntClass, NatClass, FloatClass, FixedIntClass, FixedNatClass, VecClass, OptClass, RecordClass, TupleClass, VariantClass, _RecClass, RecClass, PrincipalClass, FuncClass, ServiceClass, Empty, Reserved, Unknown, Bool, Null, Text, Int, Nat, Float32, Float64, Int8, Int16, Int32, Int64, Nat8, Nat16, Nat32, Nat64, Principal2, Relations, subtypeCache;
  var init_idl = __esm({
    "node_modules/@dfinity/candid/lib/esm/idl.js"() {
      init_esm();
      init_buffer();
...
variant ${k2} -> ${e.message}`);
      ...
      _RecClass = class _RecClass extends ConstructType {
        constructor() {
          super(...arguments);
...
`;
  ...
  var DEFAULT_INGRESS_EXPIRY_DELTA_IN_MSECS, IC_REQUEST_DOMAIN_SEPARATOR, IC_RESPONSE_DOMAIN_SEPARATOR, IC_REQUEST_AUTH_DELEGATION_DOMAIN_SEPARATOR;
  var init_constants = __esm({
    "node_modules/@dfinity/agent/lib/esm/constants.js"() {
      DEFAULT_INGRESS_EXPIRY_DELTA_IN_MSECS = 5 * 60 * 1e3;
      IC_REQUEST_DOMAIN_SEPARATOR = new TextEncoder().encode("\nic-request");
      IC_RESPONSE_DOMAIN_SEPARATOR = new TextEncoder().encode("\vic-response");
      IC_REQUEST_AUTH_DELEGATION_DOMAIN_SEPARATOR = new TextEncoder().encode("ic-request-auth-delegation");
    }
  });

  // node_modules/@dfinity/agent/lib/esm/auth.js
  var SignIdentity, AnonymousIdentity;
  var init_auth = __esm({
    "node_modules/@dfinity/agent/lib/esm/auth.js"() {
      init_esm();
      init_request_id();
      ...
      SignIdentity = class {
        ...
        transformRequest(request2) {
          return __async(this, null, function* () {
            const _a2 = request2, { body } = _a2, fields = __objRest(_a2, ["body"]);
  ...
  var w, m, L, g, c, z, Y, G, P, H, d, h, K, A, y, a, x, p, C, v, o, r, s, O;
  var init_cbor = __esm({
    "node_modules/@dfinity/cbor/dist/cbor.mjs"() {
      ...
      g = /* @__PURE__ */ ((t) => (t[t.False = 20] = "False", t[t.True = 21] = "True", t[t.Null = 22] = "Null", t[t.Undefined = 23] = "Undefined", t[t.Break = 31] = "Break", t))(g || {});
      ...
      d = /* @__PURE__ */ ((t) => (t[t.Value = 23] = "Value", t[t.OneByte = 24] = "OneByte", t[t.TwoBytes = 25] = "TwoBytes", t[t.FourBytes = 26] = "FourBytes", t[t.EightBytes = 27] = "EightBytes", t[t.Indefinite = 31] = "Indefinite", t))(d || {});
      h = false;
      K = new TextDecoder();
      A = new Uint8Array();
      a = 0;
  ...
  var Endpoint, SubmitRequestType, ReadRequestType;
  ...
  function makeNonceTransform(nonceFn = makeNonce) {
    return (request2) => __async(null, null, function* () {
  ...
  var JSON_KEY_EXPIRY, SECONDS_TO_MILLISECONDS, MILLISECONDS_TO_NANOSECONDS, MINUTES_TO_SECONDS, EXPIRY_DELTA_THRESHOLD_MILLISECONDS, Expiry;
  var init_transforms = __esm({
    "node_modules/@dfinity/agent/lib/esm/agent/http/transforms.js"() {
      init_esm2();
      init_types2();
      init_errors();
      JSON_KEY_EXPIRY = "__expiry__";
      SECONDS_TO_MILLISECONDS = BigInt(1e3);
      MILLISECONDS_TO_NANOSECONDS = BigInt(1e6);
      MINUTES_TO_SECONDS = BigInt(60);
      EXPIRY_DELTA_THRESHOLD_MILLISECONDS = BigInt(90) * SECONDS_TO_MILLISECONDS;
      Expiry = class _Expiry {
  ...
  function bls(CURVE) {
    ...
    const G1 = Object.assign(G1_, createHasher2(G1_.Point, CURVE.G1.mapToCurve, __spreadValues(__spreadValues({}, CURVE.htfDefaults), CURVE.G1.htfDefaults)));
    const G2_ = weierstrassPoints(CURVE.G2);
    const G2 = Object.assign(G2_, createHasher2(G2_.Point, CURVE.G2.mapToCurve, __spreadValues(__spreadValues({}, CURVE.htfDefaults), CURVE.G2.htfDefaults)));
    const pairingRes = createBlsPairing(CURVE.fields, G1.Point, G2.Point, __spreadProps(__spreadValues({}, CURVE.params), {
  ...
  function calcFrobeniusCoefficients(Fp4, nonResidue, modulus, degree, num = 1, divisor) {
    ...
    const towerModulus = __pow(modulus, BigInt(degree));
    const res = [];
    for (let i = 0; i < num; i++) {
      const a2 = BigInt(i + 1);
      const powers = [];
  ...
  function psiFrobenius(Fp4, Fp22, base) {
    ...
    const PSI2_X = Fp22.pow(base, (__pow(Fp4.ORDER, _2n4) - _1n6) / _3n4);
    const PSI2_Y = Fp22.pow(base, (__pow(Fp4.ORDER, _2n4) - _1n6) / _2n4);
  ...
  var _0n7, _1n7, _2n5, _3n5, _4n3, BLS_X, BLS_X_LEN, bls12_381_CURVE_G1, bls12_381_Fr, Fp, Fp2, Fp6, Fp12, G2psi, G2psi2, htfDefaults, bls12_381_CURVE_G2, COMPZERO, bls12_381, isogenyMapG2, isogenyMapG1, G1_SWU, G2_SWU;
  var init_bls12_381 = __esm({
    "node_modules/@noble/curves/esm/bls12-381.js"() {
      ...
      bls12_381 = bls({
        ...
        // G1: y² = x³ + 4
        G1: __spreadProps(__spreadValues({}, bls12_381_CURVE_G1), {
          Fp,
          htfDefaults: __spreadProps(__spreadValues({}, htfDefaults), { m: 1, DST: "BLS_SIG_BLS12381G1_XMD:SHA-256_SSWU_RO_NUL_" }),
          wrapPrivateKey: true,
        ...
        G2: __spreadProps(__spreadValues({}, bls12_381_CURVE_G2), {
          Fp: Fp2,
          // https://datatracker.ietf.org/doc/html/rfc9380#name-clearing-the-cofactor
          // https://datatracker.ietf.org/doc/html/rfc9380#name-cofactor-clearing-for-bls12
          hEff: BigInt("0xbc69f08f2ee75b3584c6a0ea91b352888e2a8e9145ad7689986ff031508ffe1329c2f178731db956d82bf015d1212b02ec0ec69d7477c1ae954cbc06689f6a359894c0adebbf6b4e8020005aaa95551"),
          htfDefaults: __spreadValues({}, htfDefaults),
          wrapPrivateKey: true,
          allowInfinityPoint: true,
          mapToCurve: mapToG2,
          // Checks is the point resides in prime-order subgroup.
  ...
  var MILLISECOND_TO_NANOSECONDS, decodeLeb128, decodeTime;
  var init_leb = __esm({
    "node_modules/@dfinity/agent/lib/esm/utils/leb.js"() {
      init_esm2();
      MILLISECOND_TO_NANOSECONDS = BigInt(1e6);
      decodeLeb128 = (buf) => {
    ...
    return __async(this, null, function* () {
      switch (t[0]) {
        ...
        case NodeType.Labeled:
          return sha256(concatBytes(domain_sep("ic-hashtree-labeled"), t[1], yield reconstruct(t[2])));
        case NodeType.Fork:
          return sha256(concatBytes(domain_sep("ic-hashtree-fork"), yield reconstruct(t[1]), yield reconstruct(t[2])));
        default:
  ...
  var MINUTES_TO_MSEC, HOURS_TO_MINUTES, DAYS_TO_HOURS, DAYS_TO_MINUTES, DEFAULT_CERTIFICATE_MAX_AGE_IN_MINUTES, DEFAULT_CERTIFICATE_MAX_MINUTES_IN_FUTURE, DEFAULT_CERTIFICATE_DELEGATION_MAX_AGE_IN_MINUTES, NodeType, _disableTimeVerification, _agent, _Certificate, Certificate, DER_PREFIX, KEY_LENGTH, LookupPathStatus, LookupSubtreeStatus, LookupLabelStatus;
  var init_certificate = __esm({
    "node_modules/@dfinity/agent/lib/esm/certificate.js"() {
      ...
      init_buffer2();
      init_sha2();
      MINUTES_TO_MSEC = 60 * 1e3;
      HOURS_TO_MINUTES = 60;
      DAYS_TO_HOURS = 24;
      DAYS_TO_MINUTES = DAYS_TO_HOURS * HOURS_TO_MINUTES;
      DEFAULT_CERTIFICATE_MAX_AGE_IN_MINUTES = 5;
      DEFAULT_CERTIFICATE_MAX_MINUTES_IN_FUTURE = 5;
      DEFAULT_CERTIFICATE_DELEGATION_MAX_AGE_IN_MINUTES = 30 * DAYS_TO_MINUTES;
      (function(NodeType2) {
      ...
      _Certificate = class _Certificate {
        ...
        static createUnverified(options) {
          var _a2;
          return new _Certificate(options.certificate, options.rootKey, options.canisterId, (_a2 = options.blsVerify) != null ? _a2 : blsVerify, options.maxAgeInMinutes, options.disableTimeVerification, options.agent);
        }
        /**
          ...
          return __async(this, null, function* () {
            ...
            if (!__privateGet(this, _disableTimeVerification)) {
              ...
              if ((isCertificateTimePast || isCertificateTimeFuture) && __privateGet(this, _agent) && !__privateGet(this, _agent).hasSyncedTime()) {
                yield __privateGet(this, _agent).syncTime(this._canisterId);
            ...
            try {
              const sigVer = yield this._blsVerify(key, sig, msg);
              if (!sigVer) {
      ...
      DER_PREFIX = hexToBytes("308182301d060d2b0601040182dc7c0503010201060c2b0601040182dc7c05030201036100");
      KEY_LENGTH = 96;
  ...
  var request, fetchNodeKeys, encodePath, decodeControllers;
  var init_canisterStatus = __esm({
    "node_modules/@dfinity/agent/lib/esm/canisterStatus/index.js"() {
      ...
      init_leb();
      init_utils();
      request = (options) => __async(null, null, function* () {
        ...
        const promises = uniquePaths.map((path, index) => {
          ...
          return (() => __async(null, null, function* () {
            try {
              ...
              const response = yield agent.readState(canisterId, {
                paths: [encodedPath]
              });
              const certificate = yield Certificate.create({
  ...
  var _0n8, _1n8, _2n6, _8n2, PrimeEdwardsPoint;
  ...
  function ed25519_pow_2_252_3(x2) {
    ...
    const b5 = pow2(b4, _1n9, P2) * x2 % P2;
    ...
    const pow_p_5_8 = pow2(b250, _2n7, P2) * x2 % P2;
    return { pow_p_5_8, b2 };
  }
  ...
  function calcElligatorRistrettoMap(r0) {
    ...
    if (!Ns_D_is_sq)
      c2 = r2;
    const Nt = mod2(c2 * (r2 - _1n9) * D_MINUS_ONE_SQ - D);
    const s22 = s2 * s2;
  ...
  var _0n9, _1n9, _2n7, _3n6, _5n2, _8n3, ed25519_CURVE_p, ed25519_CURVE, ED25519_SQRT_M1, Fp3, Fn, ed25519Defaults, ed25519, SQRT_M1, SQRT_AD_MINUS_ONE, INVSQRT_A_MINUS_D, ONE_MINUS_D_SQ, D_MINUS_ONE_SQ, invertSqrt, MAX_255B, bytes255ToNumberLE, _RistrettoPoint;
  var init_ed25519 = __esm({
    "node_modules/@noble/curves/esm/ed25519.js"() {
      ...
      Fp3 = /* @__PURE__ */ (() => Field(ed25519_CURVE.p, { isLE: true }))();
      Fn = /* @__PURE__ */ (() => Field(ed25519_CURVE.n, { isLE: true }))();
      ed25519Defaults = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, ed25519_CURVE), {
        Fp: Fp3,
        hash: sha512,
        adjustScalarBytes,
        // dom2
      ...
      _RistrettoPoint = class __RistrettoPoint extends PrimeEdwardsPoint {
        ...
        static fromBytes(bytes) {
          ...
          const y2 = mod2(u1 * Dy);
          const t = mod2(x2 * y2);
          if (!isValid || isNegativeLE(t, P2) || y2 === _0n9)
            throw new Error("invalid ristretto255 encoding 2");
          return new __RistrettoPoint(new ed25519.Point(x2, y2, _1n9, t));
        }
        /**
  ...
  var _a, _b, _inner, _expirationTime, ExpirableMap;
  ...
  var encodeLenBytes, encodeLen, decodeLenBytes, decodeLen, DER_COSE_OID, ED25519_OID, SECP256K1_OID, BLS12_381_G2_OID, unwrapDER;
  var init_der = __esm({
    "node_modules/@dfinity/agent/lib/esm/der.js"() {
      init_errors();
      init_buffer2();
      ...
      BLS12_381_G2_OID = Uint8Array.from([
        ...[48, 29],
  ...
  var _rawKey, _derKey, _Ed25519PublicKey, Ed25519PublicKey;
  var init_public_key = __esm({
    "node_modules/@dfinity/agent/lib/esm/public_key.js"() {
      init_der();
      init_errors();
      _Ed25519PublicKey = class _Ed25519PublicKey {
  ...
  var RANDOMIZATION_FACTOR, MULTIPLIER, INITIAL_INTERVAL_MSEC, MAX_INTERVAL_MSEC, MAX_ELAPSED_TIME_MSEC, MAX_ITERATIONS, _currentInterval, _randomizationFactor, _multiplier, _maxInterval, _startTime, _maxElapsedTime, _maxIterations, _date, _count, _ExponentialBackoff, ExponentialBackoff;
  var init_backoff = __esm({
    "node_modules/@dfinity/agent/lib/esm/polling/backoff.js"() {
      ...
      MAX_ITERATIONS = 10;
      _ExponentialBackoff = class _ExponentialBackoff {
  ...
  var RequestStatusResponseStatus, MINUTE_TO_MSECS, MSECS_TO_NANOSECONDS, DEFAULT_TIME_DIFF_MSECS, IC_ROOT_KEY, IC0_DOMAIN, IC0_SUB_DOMAIN, ICP0_DOMAIN, ICP0_SUB_DOMAIN, ICP_API_DOMAIN, ICP_API_SUB_DOMAIN, HTTP_STATUS_OK, HTTP_STATUS_ACCEPTED, HTTP_STATUS_NOT_FOUND, _rootKeyPromise, _shouldFetchRootKey, _timeDiffMsecs, _hasSyncedTime, _syncTimePromise, _shouldSyncTime, _identity, _fetch, _fetchOptions, _callOptions, _credentials, _retryTimes, _backoffStrategy, _maxIngressExpiryInMinutes, _HttpAgent_instances, maxIngressExpiryInMs_get, _queryPipeline, _updatePipeline, _subnetKeys, _verifyQuerySignatures, requestAndRetryQuery_fn, requestAndRetry_fn, _verifyQueryResponse, asyncGuard_fn, rootKeyGuard_fn, syncTimeGuard_fn, _HttpAgent, HttpAgent;
  var init_http = __esm({
    "node_modules/@dfinity/agent/lib/esm/agent/http/index.js"() {
      init_esm();
      init_errors();
      ...
      MSECS_TO_NANOSECONDS = 1e6;
      DEFAULT_TIME_DIFF_MSECS = 0;
      ...
      _HttpAgent = class _HttpAgent {
        ...
        static createSync(options = {}) {
          return new this(__spreadValues({}, options));
        }
        static create() {
          return __async(this, arguments, function* (options = {}) {
            var _a2;
            const agent = _HttpAgent.createSync(options);
            yield __privateMethod(_a2 = agent, _HttpAgent_instances, asyncGuard_fn).call(_a2);
            return agent;
          });
        }
        static from(agent) {
          return __async(this, null, function* () {
            ...
            try {
              if ("config" in agent) {
                return yield _HttpAgent.create(agent.config);
              }
              return yield _HttpAgent.create({
                fetch: agent._fetch,
        ...
        getPrincipal() {
          return __async(this, null, function* () {
            ...
            return (yield __privateGet(this, _identity)).getPrincipal();
          });
        }
        /**
        ...
        call(canisterId, options, identity) {
          return __async(this, null, function* () {
            ...
            const id = yield identity != null ? identity : __privateGet(this, _identity);
            if (!id) {
              throw ExternalError.fromCode(new IdentityInvalidErrorCode());
            }
            const canister = Principal.from(canisterId);
            const ecid = options.effectiveCanisterId ? Principal.from(options.effectiveCanisterId) : canister;
            yield __privateMethod(this, _HttpAgent_instances, asyncGuard_fn).call(this, ecid);
            ...
            try {
              const requestSync = () => {
                ...
                return __privateGet(this, _fetch).call(this, "" + new URL(`/api/v3/canister/${ecid.toText()}/call`, this.host), __spreadProps(__spreadValues(__spreadValues({}, __privateGet(this, _callOptions)), transformedRequest.request), {
                  body
                }));
              };
              const requestAsync = () => {
                this.log.print(`fetching "/api/v2/canister/${ecid.toText()}/call" with request:`, transformedRequest);
                return __privateGet(this, _fetch).call(this, "" + new URL(`/api/v2/canister/${ecid.toText()}/call`, this.host), __spreadProps(__spreadValues(__spreadValues({}, __privateGet(this, _callOptions)), transformedRequest.request), {
                  body
                }));
              };
              const requestFn = callSync ? requestSync : requestAsync;
              const _b2 = yield __privateMethod(this, _HttpAgent_instances, requestAndRetry_fn).call(this, {
                requestFn,
                backoff: backoff2,
                tries: 0
              }), { responseBodyBytes } = _b2, response = __objRest(_b2, ["responseBodyBytes"]);
              ...
              if (error instanceof AgentError) {
                if (error.hasCode(HttpV3ApiNotSupportedErrorCode)) {
                  ...
                  return this.call(canisterId, __spreadProps(__spreadValues({}, options), {
                    // disable v3 api
                    callSync: false
                  }), identity);
                } else if (error.hasCode(IngressExpiryInvalidErrorCode) && !__privateGet(this, _hasSyncedTime)) {
                  yield this.syncTime(canister);
        ...
        query(canisterId, fields, identity) {
          return __async(this, null, function* () {
            ...
            transformedRequest = yield this._transform({
              request: {
                method: "POST",
                headers: __spreadValues({
                  "Content-Type": "application/cbor"
            ...
            const makeQuery = () => __async(this, null, function* () {
              const query = yield __privateMethod(this, _HttpAgent_instances, requestAndRetryQuery_fn).call(this, args);
              return __spreadValues({
                requestDetails: request2
              }, query);
            });
            const getSubnetStatus = () => __async(this, null, function* () {
              const cachedSubnetStatus = __privateGet(this, _subnetKeys).get(ecid.toString());
              if (cachedSubnetStatus) {
                return cachedSubnetStatus;
              }
              yield this.fetchSubnetKeys(ecid.toString());
            ...
            try {
              if (!__privateGet(this, _verifyQuerySignatures)) {
                return yield makeQuery();
              }
              const [queryWithDetails, subnetStatus] = yield Promise.all([makeQuery(), getSubnetStatus()]);
              try {
                ...
                const updatedSubnetStatus = yield getSubnetStatus();
        ...
        createReadStateRequest(fields, identity) {
          return __async(this, null, function* () {
            yield __privateMethod(this, _HttpAgent_instances, asyncGuard_fn).call(this);
            const id = yield identity != null ? identity : __privateGet(this, _identity);
            if (!id) {
              throw ExternalError.fromCode(new IdentityInvalidErrorCode());
            }
            const sender = id.getPrincipal();
            const transformedRequest = yield this._transform({
              request: {
                method: "POST",
                headers: __spreadValues({
                  "Content-Type": "application/cbor"
        ...
        readState(canisterId, fields, _identity2, request2) {
          return __async(this, null, function* () {
            yield __privateMethod(this, _HttpAgent_instances, rootKeyGuard_fn).call(this);
            const canister = Principal.from(canisterId);
            ...
            if (request2) {
              ...
              const identity = yield __privateGet(this, _identity);
              if (!identity) {
                throw ExternalError.fromCode(new IdentityInvalidErrorCode());
              }
              transformedRequest = yield this.createReadStateRequest(fields, identity);
            }
            this.log.print(`fetching "/api/v2/canister/${canister}/read_state" with request:`, transformedRequest);
            const backoff2 = __privateGet(this, _backoffStrategy).call(this);
            try {
              const { responseBodyBytes } = yield __privateMethod(this, _HttpAgent_instances, requestAndRetry_fn).call(this, {
                requestFn: () => __privateGet(this, _fetch).call(this, "" + new URL(`/api/v2/canister/${canister.toString()}/read_state`, this.host), __spreadProps(__spreadValues(__spreadValues({}, __privateGet(this, _fetchOptions)), transformedRequest.request), {
         ...
         */
        syncTime(canisterIdOverride) {
          return __async(this, null, function* () {
            var _a2;
            __privateSet(this, _syncTimePromise, (_a2 = __privateGet(this, _syncTimePromise)) != null ? _a2 : (() => __async(this, null, function* () {
              var _a3;
              yield __privateMethod(this, _HttpAgent_instances, rootKeyGuard_fn).call(this);
              ...
              try {
                ...
                const replicaTimes = yield Promise.all(Array(3).fill(null).map(() => __async(this, null, function* () {
            ...
            yield __privateGet(this, _syncTimePromise).finally(() => {
              __privateSet(this, _syncTimePromise, null);
            });
          });
        }
        status() {
          return __async(this, null, function* () {
            ...
            const { responseBodyBytes } = yield __privateMethod(this, _HttpAgent_instances, requestAndRetry_fn).call(this, {
              backoff: backoff2,
              requestFn: () => __privateGet(this, _fetch).call(this, "" + new URL(`/api/v2/status`, this.host), __spreadValues({ headers }, __privateGet(this, _fetchOptions))),
              tries: 0
            });
        ...
        fetchRootKey() {
          return __async(this, null, function* () {
            var _a2;
            __privateSet(this, _rootKeyPromise, (_a2 = __privateGet(this, _rootKeyPromise)) != null ? _a2 : (() => __async(this, null, function* () {
              const value = yield this.status();
              this.rootKey = value.root_key;
              return this.rootKey;
            }))());
            return yield __privateGet(this, _rootKeyPromise).finally(() => {
              __privateSet(this, _rootKeyPromise, null);
            });
          });
        }
        ...
        fetchSubnetKeys(canisterId) {
          return __async(this, null, function* () {
            const effectiveCanisterId = Principal.from(canisterId);
            yield __privateMethod(this, _HttpAgent_instances, asyncGuard_fn).call(this, effectiveCanisterId);
      ...
      requestAndRetryQuery_fn = function(args) {
        return __async(this, null, function* () {
          var _a2, _b2;
          ...
          try {
            ...
            const fetchResponse = yield __privateGet(this, _fetch).call(this, "" + new URL(`/api/v2/canister/${ecid.toString()}/query`, this.host), __spreadProps(__spreadValues(__spreadValues({}, __privateGet(this, _fetchOptions)), transformedRequest.request), {
              body
            }));
            if (fetchResponse.status === HTTP_STATUS_OK) {
              const queryResponse = decode3(uint8FromBufLike2(yield fetchResponse.arrayBuffer()));
              response = __spreadProps(__spreadValues({}, queryResponse), {
                httpDetails: {
                  ok: fetchResponse.ok,
              ...
              throw ProtocolError.fromCode(new HttpErrorCode(fetchResponse.status, fetchResponse.statusText, httpHeadersTransform(fetchResponse.headers), yield fetchResponse.text()));
            }
          } catch (error) {
  ...
  ${error}
  Retrying query.`);
              return yield __privateMethod(this, _HttpAgent_instances, requestAndRetryQuery_fn).call(this, __spreadProps(__spreadValues({}, args), { tries: tries + 1 }));
            }
            if (error instanceof AgentError) {
              throw error;
            }
      ...
      requestAndRetry_fn = function(args) {
        return __async(this, null, function* () {
          ...
          try {
            ...
            if (response.status === HTTP_STATUS_OK) {
              responseBodyBytes = uint8FromBufLike2(yield response.clone().arrayBuffer());
            }
          } catch (error) {
            if (tries < __privateGet(this, _retryTimes)) {
  ...
  ${error}
  Retrying request.`);
              return yield __privateMethod(this, _HttpAgent_instances, requestAndRetry_fn).call(this, { requestFn, backoff: backoff2, tries: tries + 1 });
            }
            throw TransportError.fromCode(new HttpFetchErrorCode(error));
          }
      ...
      asyncGuard_fn = function(canisterIdOverride) {
        return __async(this, null, function* () {
          yield Promise.all([__privateMethod(this, _HttpAgent_instances, rootKeyGuard_fn).call(this), __privateMethod(this, _HttpAgent_instances, syncTimeGuard_fn).call(this, canisterIdOverride)]);
        });
      };
      rootKeyGuard_fn = function() {
        return __async(this, null, function* () {
          if (this.rootKey) {
            return;
          } else if (this.rootKey === null && this.host.toString() !== "https://icp-api.io" && __privateGet(this, _shouldFetchRootKey)) {
            yield this.fetchRootKey();
          } else {
            throw ExternalError.fromCode(new MissingRootKeyErrorCode(__privateGet(this, _shouldFetchRootKey)));
          }
        });
      };
      syncTimeGuard_fn = function(canisterIdOverride) {
        return __async(this, null, function* () {
          if (__privateGet(this, _shouldSyncTime) && !this.hasSyncedTime()) {
            yield this.syncTime(canisterIdOverride);
          }
        });
      };
  ...
  function conditionalDelay(condition, timeInMsec) {
    return (canisterId, requestId, status) => __async(null, null, function* () {
  ...
  function timeout(timeInMsec) {
    ...
    return (_canisterId, requestId, status) => __async(null, null, function* () {
      if (Date.now() > end) {
  ...
  function chain(...strategies) {
    return (canisterId, requestId, status) => __async(null, null, function* () {
      for (const a2 of strategies) {
        yield a2(canisterId, requestId, status);
      }
    });
  }
  var FIVE_MINUTES_IN_MSEC;
  ...
  function pollForResponse(_0, _1, _2) {
    return __async(this, arguments, function* (agent, canisterId, requestId, options = {}) {
      var _a2, _b2;
      ...
      if (preSignReadStateRequest) {
        currentRequest = yield constructRequest({
          paths: [path],
          agent,
          pollingOptions: options
        });
        state = yield agent.readState(canisterId, { paths: [path] }, void 0, currentRequest);
      } else {
        state = yield agent.readState(canisterId, { paths: [path] });
      }
      if (agent.rootKey == null) {
        throw ExternalError.fromCode(new MissingRootKeyErrorCode());
      }
      ...
      switch (status) {
        ...
        case RequestStatusResponseStatus.Processing: {
          ...
          return pollForResponse(agent, canisterId, requestId, __spreadProps(__spreadValues({}, options), {
  ...
  function constructRequest(options) {
    return __async(this, null, function* () {
      ...
      const request2 = yield (_a2 = agent.createReadStateRequest) == null ? void 0 : _a2.call(agent, {
        paths
      }, void 0);
  ...
  function _createActorMethod(actor, methodName, func, blsVerify2) {
    ...
    if (func.annotations.includes("query") || func.annotations.includes("composite_query")) {
      caller = (options, ...args) => __async(null, null, function* () {
        var _a2, _b2;
        options = __spreadValues(__spreadValues({}, options), (_b2 = (_a2 = actor[metadataSymbol].config).queryTransform) == null ? void 0 : _b2.call(_a2, methodName, args, __spreadValues(__spreadValues({}, actor[metadataSymbol].config), options)));
        const agent = options.agent || actor[metadataSymbol].config.agent || new HttpAgent();
        const cid = Principal.from(options.canisterId || actor[metadataSymbol].config.canisterId);
        const arg = idl_exports.encode(func.argTypes, args);
        const result = yield agent.query(cid, {
          methodName,
          arg,
          effectiveCanisterId: options.effectiveCanisterId
        });
        const httpDetails = __spreadProps(__spreadValues({}, result.httpDetails), {
      ...
      caller = (options, ...args) => __async(null, null, function* () {
        var _a2, _b2;
        options = __spreadValues(__spreadValues({}, options), (_b2 = (_a2 = actor[metadataSymbol].config).callTransform) == null ? void 0 : _b2.call(_a2, methodName, args, __spreadValues(__spreadValues({}, actor[metadataSymbol].config), options)));
        const agent = options.agent || actor[metadataSymbol].config.agent || HttpAgent.createSync();
        const { canisterId, effectiveCanisterId, pollingOptions } = __spreadValues(__spreadValues(__spreadValues({}, DEFAULT_ACTOR_CONFIG), actor[metadataSymbol].config), options);
        const cid = Principal.from(canisterId);
        const ecid = effectiveCanisterId !== void 0 ? Principal.from(effectiveCanisterId) : cid;
        const arg = idl_exports.encode(func.argTypes, args);
        const { requestId, response, requestDetails } = yield agent.call(cid, {
          methodName,
          arg,
        ...
        if (isV3ResponseBody(response.body)) {
          ...
          certificate = yield Certificate.create({
            certificate: cert,
            rootKey: agent.rootKey,
        ...
        if (response.status === 202) {
          const pollOptions = __spreadProps(__spreadValues({}, pollingOptions), {
            blsVerify: blsVerify2
          });
          const response2 = yield pollForResponse(agent, ecid, requestId, pollOptions);
          certificate = response2.certificate;
          reply = response2.reply;
        }
        const shouldIncludeHttpDetails = func.annotations.includes(ACTOR_METHOD_WITH_HTTP_DETAILS);
        const shouldIncludeCertificate = func.annotations.includes(ACTOR_METHOD_WITH_CERTIFICATE);
        const httpDetails = __spreadProps(__spreadValues({}, response), { requestDetails });
        if (reply !== void 0) {
  ...
  var metadataSymbol, Actor, DEFAULT_ACTOR_CONFIG, ACTOR_METHOD_WITH_HTTP_DETAILS, ACTOR_METHOD_WITH_CERTIFICATE;
  var init_actor = __esm({
    "node_modules/@dfinity/agent/lib/esm/actor.js"() {
      ...
      init_http();
      init_utils();
      metadataSymbol = Symbol.for("ic-agent-metadata");
      Actor = class _Actor {
        /**
        ...
        static createActorClass(interfaceFactory, options) {
          ...
          class CanisterActor extends _Actor {
            constructor(config) {
              ...
              super({
                config: __spreadProps(__spreadValues(__spreadValues({}, DEFAULT_ACTOR_CONFIG), config), {
                  canisterId
                }),
                service
              });
      ...
      ACTOR_METHOD_WITH_HTTP_DETAILS = "http-details";
      ACTOR_METHOD_WITH_CERTIFICATE = "certificate";
    }
  });

  // node_modules/@dfinity/agent/lib/esm/fetch_candid.js
  var init_fetch_candid = __esm({
    "node_modules/@dfinity/agent/lib/esm/fetch_candid.js"() {
    }
  });
  ...
  var _rawKey2, _derKey2, _Ed25519PublicKey2, Ed25519PublicKey2, _publicKey, _privateKey, _Ed25519KeyIdentity, Ed25519KeyIdentity;
  var init_ed255192 = __esm({
    "node_modules/@dfinity/identity/lib/esm/identity/ed25519.js"() {
      ...
      init_ed25519();
      init_utils();
      _Ed25519PublicKey2 = class _Ed25519PublicKey2 {
        // `fromRaw` and `fromDer` should be used for instantiation, not this constructor.
        constructor(key) {
      ...
      Ed25519PublicKey2 = _Ed25519PublicKey2;
      _Ed25519KeyIdentity = class _Ed25519KeyIdentity extends SignIdentity {
        // `fromRaw` and `fromDer` should be used for instantiation, not this constructor.
  ...
  var Delegation, DelegationChain, DelegationIdentity, _delegation, _PartialDelegationIdentity, PartialDelegationIdentity;
  var init_delegation = __esm({
    "node_modules/@dfinity/identity/lib/esm/identity/delegation.js"() {
      ...
      _PartialDelegationIdentity = class _PartialDelegationIdentity extends PartialIdentity {
      ...
      PartialDelegationIdentity = _PartialDelegationIdentity;
    }
  });
      ...
      IdleManager = class {
        ...
        constructor(options = {}) {
          ...
          if (options == null ? void 0 : options.captureScroll) {
            const scroll = debounce(_resetTimer, (_a2 = options == null ? void 0 : options.scrollDebounce) != null ? _a2 : 100);
  ...
  var init_db = __esm({
    "node_modules/@dfinity/auth-client/lib/esm/db.js"() {
      ...
      _openDbStore = (..._0) => __async(null, [..._0], function* (dbName = AUTH_DB_NAME, storeName = OBJECT_STORE_NAME, version) {
      ...
      IdbKeyVal = class _IdbKeyVal {
        ...
        static create(options) {
          return __async(this, null, function* () {
            const { dbName = AUTH_DB_NAME, storeName = OBJECT_STORE_NAME, version = DB_VERSION } = options != null ? options : {};
        ...
        get(key) {
          return __async(this, null, function* () {
            var _a2;
            return (_a2 = yield _getValue(this._db, this._storeName, key)) != null ? _a2 : null;
          });
        }
        /**
         * Remove a key
  ...
  var KEY_STORAGE_KEY, KEY_STORAGE_DELEGATION, KEY_VECTOR, DB_VERSION, isBrowser, LocalStorage, _options, IdbStorage;
  ...
  var NANOSECONDS_PER_SECOND, SECONDS_PER_HOUR, NANOSECONDS_PER_HOUR, IDENTITY_PROVIDER_DEFAULT, IDENTITY_PROVIDER_ENDPOINT, DEFAULT_MAX_TIME_TO_LIVE, ECDSA_KEY_LABEL, ED25519_KEY_LABEL, INTERRUPT_CHECK_INTERVAL, ERROR_USER_INTERRUPT, AuthClient;
  var init_esm5 = __esm({
    "node_modules/@dfinity/auth-client/lib/esm/index.js"() {
      init_esm3();
      init_esm4();
      ...
      init_db();
      init_idleManager();
      NANOSECONDS_PER_SECOND = BigInt(1e9);
      SECONDS_PER_HOUR = BigInt(3600);
      NANOSECONDS_PER_HOUR = NANOSECONDS_PER_SECOND * SECONDS_PER_HOUR;
      IDENTITY_PROVIDER_DEFAULT = "https://identity.internetcomputer.org";
      IDENTITY_PROVIDER_ENDPOINT = "#authorize";
      DEFAULT_MAX_TIME_TO_LIVE = BigInt(8) * NANOSECONDS_PER_HOUR;
      ...
      AuthClient = class {
        ...
        static create() {
          return __async(this, arguments, function* (options = {}) {
            var _a2, _b2, _c;
            const storage = (_a2 = options.storage) != null ? _a2 : new IdbStorage();
            const keyType = (_b2 = options.keyType) != null ? _b2 : ECDSA_KEY_LABEL;
            let key = null;
            if (options.identity) {
            ...
            if (!key) {
              if (keyType === ED25519_KEY_LABEL) {
                ...
                yield storage.set(KEY_STORAGE_KEY, JSON.stringify(key.toJSON()));
              } else {
                ...
                yield storage.set(KEY_STORAGE_KEY, key.getKeyPair());
              }
            }
        ...
        login(options) {
          return __async(this, null, function* () {
            ...
            const maxTimeToLive = (_b2 = loginOptions == null ? void 0 : loginOptions.maxTimeToLive) != null ? _b2 : DEFAULT_MAX_TIME_TO_LIVE;
            const identityProviderUrl = new URL(((_c = loginOptions == null ? void 0 : loginOptions.identityProvider) == null ? void 0 : _c.toString()) || IDENTITY_PROVIDER_DEFAULT);
            ...
            this._idpWindow = (_e = window.open(identityProviderUrl.toString(), "idpWindow", loginOptions == null ? void 0 : loginOptions.windowOpenerFeatures)) != null ? _e : void 0;
